...
def test_admin_menu_puts_classes_and_programs_on_top_then_students(db):
    ...
    assert [b["text"] for b in rows[0]] == [texts.BTN_ADMIN_CLASSES, texts.BTN_ADMIN_PLANS]
    assert [b["text"] for b in rows[1]] == [texts.BTN_ADMIN_STUDENTS]
