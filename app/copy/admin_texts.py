...
BTN_EDIT_STUDENT = "✏️ ویرایش اطلاعات"
EDIT_STUDENT_TITLE = "✏️ کدام مورد ویرایش شود؟"
BTN_EDIT_NAME = "👤 نام"
BTN_EDIT_PHONE = "📞 شماره تماس"
BTN_EDIT_PHONE2 = "📞 شماره دوم"
ASK_EDIT_NAME = "نام جدید را بفرست:"
ASK_EDIT_PHONE = "شماره تماس جدید را بفرست (یا «➖ حذف»):"
ASK_EDIT_PHONE2 = "شماره دوم را بفرست (یا «➖ حذف»):"
LABEL_PHONE2 = "شماره دوم"
EDIT_DONE = "🟢 ویرایش ذخیره شد."
CLEAR_WORD = "حذف"
...
ASK_COURSE_ALLOWED = (
    "سقف غیبت غیرمجاز این دوره را بفرست:\n"
    "بیشتر از این تعداد، غیبت غیرمجاز ثبت نمی‌شود. (0 یعنی بدون محدودیت)"
)
...
BTN_REACTIVATE_COURSE = "🔄 فعال‌سازی مجدد دوره"
BTN_RENEW_COURSE = "🔄 تمدید دوره"
ASK_RENEW_SESSIONS = "تعداد جلسات دورهٔ جدید را بفرست (عدد):"
CONFIRM_RENEW = (
    "🔄 دورهٔ «{title}» با همین شرایط دوباره فعال شود؟\n"
    "تعداد جلسات به {n} برمی‌گردد و حضور و غیاب از نو شروع می‌شود؛ "
    "ریز جلسات دورهٔ فعلی برای شاگرد ارسال می‌شود."
)
BTN_YES_RENEW = "🔄 بله، تمدید کن"
RENEWED = "🟢 دوره با همین شرایط تمدید شد و از نو فعال شد."
CANCEL_CREDIT_APPLIED = "🎁 اعتبار جلسات لغو‌شدهٔ مربی: {amount} تومان روی این دوره اعمال شد."
BTN_EDIT_COURSE = "✏️ ویرایش دوره"
EDIT_COURSE_TITLE = "✏️ کدام مورد ویرایش شود؟"
BTN_EDIT_TUITION = "💰 شهریه"
BTN_EDIT_GYM = "🏟 ورودی باشگاه"
...
ATTEND_DAY_TITLE = (
    "📅 حضور و غیاب — {date} ({weekday})\n"
    "روی هر شاگرد بزن تا وضعیت جلسهٔ آن روزش ثبت شود 👇"
)
NO_SESSIONS_DAY = "این روز جلسه‌ای در برنامه نیست."
PREV_DAY = "◀️ روز قبل"
TODAY = "📅 امروز"
NEXT_DAY = "روز بعد ▶️"
BTN_ALL_COURSES = "📚 همهٔ دوره‌ها"
BTN_BACK_TO_DAY = "🔙 بازگشت به روز"
BTN_MOVE_SESSION = "🔀 جایگزین"
ASK_MOVE_DATE = (
    "تاریخ جدید این جلسه را به‌صورت شمسی بفرست (نمونه: 1405/05/20):\n"
