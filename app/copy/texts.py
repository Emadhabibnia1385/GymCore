...
# Real button colours are applied via the Telegram `style` field (Bot API,
# Feb 2026): primary=blue (register/order), success=green (my classes/programs),
# danger=red (contact). See keyboards.main_menu. Bale ignores styling (it gets
# plain buttons), so the labels keep their own topic emoji.
...
# --- Registration (phone, for Telegram↔Bale sync) ---
BTN_SHARE_PHONE = "📱 ارسال شماره‌ی من"
ASK_PHONE = (
    "📱 سلام! برای شروع، شماره‌ی موبایلت را برایم بفرست.\n"
    "با دکمه‌ی «📱 ارسال شماره‌ی من» بفرست یا خودت به شکل 09xxxxxxxxx تایپ کن.\n\n"
    "🔒 این شماره فقط برای این است که کلاس‌ها و برنامه‌هایت در تلگرام و بله هماهنگ باشند."
)
INVALID_PHONE = "شماره درست به نظر نمی‌رسد 🤔\nنمونه‌ی درست: 09123456789"
REGISTERED = "🟢 خوش آمدی! حسابت ثبت شد. حالا از منوی زیر استفاده کن 👇"
NEED_PHONE = "برای شروع، /start را بزن و شماره‌ی موبایلت را بفرست."

TITLE_MY_COURSES = "🗓 کلاس‌های من"
TITLE_MY_PROGRAMS = "📄 برنامه‌های من — یکی را برای دریافت انتخاب کن:"
PROGRAM_SENT = "🟢 این هم برنامه‌ات. سلامت باشی!"

NO_COURSES = (
    "🏋️ هنوز کلاسی ثبت‌نام نکردی!\n"
    "همین الان از راه‌های ارتباطی زیر با من در تماس باش و کلاس موردنظرت را "
    "آنلاین یا حضوری ثبت‌نام کن."
)
NO_PROGRAMS = (
    "📖 هنوز برنامه‌ی غذایی یا ورزشی برایت ثبت نشده است.\n"
    "همین الان از دکمه‌ی زیر برنامه‌ی موردنظرت را سفارش بده."
)
...
BTN_ADMIN_CONTACTS = "📞 راه‌های ارتباطی"
BTN_ADMIN_START = "🖼 متن و پوستر استارت"
